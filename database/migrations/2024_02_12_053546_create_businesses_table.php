...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('businesses', function (Blueprint $table) {
            ...
            $table->double('fees', 14, 2)->default(0);
            $table->double('service_charge', 14, 2)->default(0);
            ...
            $table->double('inside_delivery_charge', 14, 2)->default(0);
            $table->double('outside_delivery_charge', 14, 2)->default(0);
            $table->double('free_delivery_charges_limit', 14, 2)->default(0);
            $table->double('customer_commission_limit', 14, 2)->default(0);
